...
module.exports = {
  ...
  logChat: function (name, callback) {
    var chatId = -1 // eslint-disable-line no-unused-vars
    if (name !== undefined) {
  ...
  logUserType: function (name, callback) {
    var typeId = -1 // eslint-disable-line no-unused-vars
    if (name !== undefined) {
      db.conn.serialize(function () {
  ...
  logUser: function (name, firstName, lastName, userTypeId, callback) {
    var userId = -1 // eslint-disable-line no-unused-vars
  ...
  logMessageType: function (name, callback) {
    var messageTypeId = -1 // eslint-disable-line no-unused-vars
    if (name !== undefined) {
      db.conn.serialize(function () {
  ...
  logMessageData: function (data, chatId, userId, messageTypeId, timestamp, callback) {
    var messageId = -1 // eslint-disable-line no-unused-vars
    if (data !== undefined) {
      db.conn.serialize(function () {
